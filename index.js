  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        ...
        - Est-ce que votre cabinet travaille avec mon secteur ?
        ...
        - Est-ce qu’on peut vous rencontrer ?

        Si une question sort du cadre (ex : météo ou blague), reste poli et recentre sur l’objectif de l’assistant.` 
        }
,
        ...messages,
      ],
